...
public class ParabolaController : MonoBehaviour
{
    ...
    //gizmo
    [SerializeField] protected ParabolaFly gizmo;

    //draw
    [SerializeField]protected ParabolaFly parabolaFly;
    ...
    public class ParabolaFly
    {
        ...
        [SerializeField] protected Parabola3D[] parabolas;
        [SerializeField] protected float[] partDuration;
        [SerializeField] protected float completeDuration;
